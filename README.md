...
Использование ридов с множественным картированием очевидно предоставляет больший объем информации и позволяет увеличить "чувствительность" для обнаружения пиков, однако вместе с этим могут увеличиваться ложные сигналы. В основном используют уникально картированные чтения и обычно этого достаточно
